   ...
   <div class="text-center">
      ...
      <div style="margin-left:6rem;">
         <span class="text-header text-bold text-danger">
            PEMERINTAH DAERAH PROVINSI JAWA TIMUR <br> DINAS PENDIDIKAN <br>
               <span class="size2">CABANG DINAS PENDIDIKAN WILAYAH MALANG</span> <br> 
               SEKOLAH MENENGAH KEJURUAN START UP MALANG <br>
         </span>
